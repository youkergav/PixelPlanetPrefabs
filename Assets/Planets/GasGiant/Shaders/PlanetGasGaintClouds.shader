Shader "Planet/GasGiant/Clouds"
{
    Properties
    {
    	...
    	_CloudCover("Cloud Cover", range(0.0, 1.0)) = 0
	    _CloudCurve("Cloud Curve", range(1.0, 2.0)) = 1.3
	    _LightBorder1("Light Border 1", range(0.0, 1.0)) = 0.692
	    _LightBorder2("Light Border 2", range(0.0, 1.0)) = 0.666

	    _Color("Color 1", Color) = (59,32,39,1)
