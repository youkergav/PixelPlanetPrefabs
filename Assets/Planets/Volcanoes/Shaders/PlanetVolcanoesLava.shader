Shader "Planet/Volcanoes/Lava"
{
    Properties
    {
	    ...
	    _LightBorder1("Light Border 1", range(0.0, 1.0)) = 0.035
	    _LightBorder2("Light Border 2", range(0.0, 1.0)) = 0.11
		_FlowRate("Lava Flow", range(0.0, 1.0)) = 0.0
    ...
    SubShader
    {
        ...
        Pass
        {
			...
			fixed4 frag(v2f i) : COLOR {
				...
				river_fbm = step(_FlowRate, river_fbm);
